...
excerpt: Switching from Vim to Emacs
draft: true
---
#+END_HTML
...
And then I discovered [[http://orgmode.org/][Ord mode]]. Org mode is astonishing. I can track every issue I'm working on, support tickets I have
...
well-documented org-mode file, which emacs then publishes alongside my blog posts in an [[/static/emacs-config/config.html][HTML file]]. This means that my
